...
public class WordsearchAlgorithm {
	...
	// private String[] findMarks = { startOfQuestion, endOfQuestion, startOfAnswer,
	// endOfRightAnswer, endOfWrongAnswer };
	...
	/*
	 * Diese Methode Filter die richtigen Fragen und Antworten aus einem Question
	 * Package
	 */
...
// 	}
	...
	/*
	 * Diese Methode Filtert aus den gegebenen QuestionPackage alle Fragen und
	 * antworten die zusammengehören
	 */
	public ArrayList<QAModel> filterQuestionsFromPackage(String pack) {
		...
		// Diese Variable ist dafür da, damit immer an der richtigen Stelle das
		// Leerzeichen einsortiert wird
		int append = 0;

		// Diese Schleife schaut, ob vor der { ein Leerzeichen ist. Wenn nicht, wird
		// eins eingefügt.
...
//		int countWrongAnswer = 0;
		...
		// Diese Variable beinhaltet ein fertigen String, der mit dem StringBuffer
		...
		// Hier werden alle Absätze durch eine Leertaste ersetzt, damit es später nicht
		// zu formatierungsfehlern kommt.
